...
const App = () => {
    ...
    try {
      ...
      agoraEngine.registerEventHandler({
        ...
        onUserJoined: (_connection, Uid) => {
          ...
          setRemoteUid(Uid);
          // Notify Caller 2 of the incoming call
          notifyIncomingCall(Uid);
        },
  ...
  const notifyIncomingCall = Uid => {
    const callUUID = 'uniqueId'; // Generate or use a unique ID for the call
    const handle = 'CallerId'; // Use the caller's identifier

    RNCallKeep.displayIncomingCall(
      callUUID,
      handle,
      `Incoming call from ${Uid}`,
    );
  };
